...
def location_to_station():
    ...
    # point_url = f"https://api.weather.gov/points/{37.727469},{-89.216655}" #I think 39.3 and -77.0 was {37.727469},{-89.216655}
...
def get_radar_images(base_map_layer='osm', layer=None, zoom=None, show_alerts=True, warnings_list=[], hazard_list=[], frames=None):
    ...
    base_map, map = get_basemap("coordinate",provider=base_map_layer,zoom=zoom,width=1024, height=768)
    size = map.size
...
def get_basemap(mode,zoom,width, height, provider='osm'):
    ...
    if mode == "coordinate":
        ...
        #map = geotiler.Map(center=(-89.216655, 37.727469), zoom=8, size=size) # Long, Lat
